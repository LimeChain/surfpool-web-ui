...
description: "Day 3 of launch week. Transaction inspection, time travel, universal faucet, and snapshot export — the dashboard that makes Solana development transparent."
date: "2025-01-23"
...
Upload an Anchor IDL via the [`surfnet_registerIdl`](https://docs.surfpool.run/rpc/cheatcodes#surfnet_registerIdl) cheatcode, and Studio immediately decodes account data into readable structs. Better still, if you're using [IaC](/blog/infrastructure-as-code) to deploy your program, your IDL will already be registered.
No configuration, no registration step — just start up your surfnet.
