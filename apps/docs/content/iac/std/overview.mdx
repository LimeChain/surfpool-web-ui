...
description: The standard library provides core functions and actions available to all Runbooks.
---
...
[View all functions](/iac/std/functions)
...
[View all actions](/iac/std/actions)
