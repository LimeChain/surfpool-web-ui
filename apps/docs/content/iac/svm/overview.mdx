...
<Cards>
  <Card title="Functions" href="/iac/svm/functions" description="Utility functions for Solana development" />
  <Card title="Actions" href="/iac/svm/actions" description="Transaction and deployment actions" />
  <Card title="Signers" href="/iac/svm/signers" description="Different signing methods" />
</Cards>
